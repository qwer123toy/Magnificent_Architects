...
import ui.SeeMyTradingHistoryPnl;
...
public class BuyPriceGUI extends JPanel {
	...
	public BuyPriceGUI(UserInfo parentUserInfo, String companyName, int companyIndex, SeeMyTradingHistoryPnl seeMyTradingHistoryPnl) {
		this.companyName = companyName;
		this.companyIndex = companyIndex;
		this.seeMyTradingHistoryPnl = seeMyTradingHistoryPnl;
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (buyStock < 0) {
					...
					try {
						...
						UserInfo userInfo = userInfoDAO.findByID(user_ID);
						seeMyTradingHistoryPnl.updateAll(parentUserInfo);
